              ...
              <div class="dropdown-menu animated zoomIn">
                <ul class="mega-dropdown-menu row">
                  ...
                  <li class="col-lg-3  m-b-30">
                    <h4 class="m-b-20">HUBUNGI KAMI</h4>
                  ...
                  <li class="col-lg-3 col-xlg-3 m-b-30">
                    <h4 class="m-b-20">Gaya daftar</h4>

                    <ul class="list-style-none">
                      <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Ini Tautan Lain</a></li>
                      <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Ini Tautan Lain</a></li>
                      <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Ini Tautan Lain</a></li>
                      <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Ini Tautan Lain</a></li>
                      <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Ini Tautan Lain</a></li>
        ...
        <div class="col-lg-12">
          <div class="card card-outline-primary">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="o_days" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                          ...
                          <option value="24hr-x7">24 jam-x7</option>
                        </select>
                      </div>
                    </div>
            ...
            <div class="form-actions">
              ...
              <a href="all_restaurant.php" class="btn btn-inverse">batal</a>
            </div>
            </form>
          </div>
        </div>
