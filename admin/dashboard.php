                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Admin Toko Anda</h4>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="card p-30">
                                        <div class="media">
                                            <div class="media-left meida media-middle">
                                                <span><i class="fa fa-tag f-s-40" aria-hidden="true"></i></span>
                                            </div>
                                            <div class="media-body media-text-right">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body media-text-right">
                                                <h2><?php $sql = "select * from users_orders WHERE status = 'in process' ";
                                                    ...
                                                    echo $rws; ?></h2>
                                                <p class="m-b-0">Memproses Pesanan</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body media-text-right">
                                                <h2><?php $sql = "select * from users_orders WHERE status = 'rejected' ";
                                                    ...
                                                    echo $rws; ?></h2>
                                                <p class="m-b-0">Pembatalan Pesanan</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
