...
<body>
    ...
    <div class="page-wrapper">
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pilih Produk favorit Anda</a></li>
        ...
        ?>
        <section class="inner-page-hero bg-image" data-image-src="images/img/Shopping.png">
            <div class="profile">
                <div class="container">
                    <div class="row">
