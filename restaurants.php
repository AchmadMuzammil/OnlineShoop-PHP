        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="#">Pilih Toko</a></li>
                    <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="#">Pilih Barang atau produk</a></li>
                    <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Beli dan Bayar</a></li>
                </ul>
            </div>
        </div>
        <div class="inner-page-hero bg-image" data-image-src="images/img/Shopping-1.png">
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<a href="dishes.php?res_id=' . $rows['rs_id'] . '" class="btn btn-purple">Lihat Toko</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
                                }
